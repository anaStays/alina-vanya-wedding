...
const events = [
  {
    time: '15:00',
    title: 'Сбор гостей',
    text: 'Время пролетит незаметно за игристым и общением с другими гостями. Мы рады приветствовать вас!',
    align: 'left',
  },
  {
    time: '16:00',
  ...
  },
  {
    time: '17:00',
    title: 'Банкет',
    text: 'Вечер продолжится за красиво накрытым столом, тостами и самой вкусной едой.',
    align: 'left',
  },
  {
    time: '22:00',
    title: 'Окончание вечера',
    text: 'Завершение праздника и трансфер в город. Спасибо, что разделили этот день с нами!',
    align: 'right',
  },
]
